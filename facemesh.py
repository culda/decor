...
FACEMESH_LEFT_IRIS = http://mp.solutions.face_mesh.FACEMESH_LEFT_IRIS
FACEMESH_RIGHT_IRIS = http://mp.solutions.face_mesh.FACEMESH_RIGHT_IRIS
    ...
    if face_detection_result.face_landmarks:
        for face_landmarks in face_detection_result.face_landmarks:
            ...
            solutions.drawing_utils.draw_landmarks(
                ...
                connections=http://mp.solutions.face_mesh.FACEMESH_TESSELATION,
                landmark_drawing_spec=None,
                connection_drawing_spec=http://mp.solutions.drawing_styles.get_default_face_mesh_tesselation_style())
            solutions.drawing_utils.draw_landmarks(
                image=annotated_image,
                landmark_list=face_landmarks_proto,
                connections=http://mp.solutions.face_mesh.FACEMESH_CONTOURS,
                landmark_drawing_spec=None,
                connection_drawing_spec=http://mp.solutions.drawing_styles.get_default_face_mesh_contours_style())
            solutions.drawing_utils.draw_landmarks(
                image=annotated_image,
                landmark_list=face_landmarks_proto,
                connections=http://mp.solutions.face_mesh.FACEMESH_IRISES,
                landmark_drawing_spec=None,
    ...
    if hand_detection_result.hand_landmarks:
        for hand_landmarks in hand_detection_result.hand_landmarks:
            ...
            solutions.drawing_utils.draw_landmarks(
                ...
                http://mp.solutions.hands.HAND_CONNECTIONS,
                http://mp.solutions.drawing_styles.get_default_hand_landmarks_style(),
                http://mp.solutions.drawing_styles.get_default_hand_connections_style())
